...
// Get list of clients for the select
...
// Process subtasks.  Crucially, handle the case where there are NO subtasks.
...
<body class="bg-gray-50">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" id="value" name="value" step="0.01" required
                                           class="form-input w-full pl-7 rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-200" style="margin-top: 0.25rem; display: block; width: 100%; border-radius: 0.375rem; border: 1px solid #d1d5db; box-shadow: 0 1px 2px 0 rgba(0,0,0,0.05); background-color: #ffffff; padding-left: 0.75rem; padding-right: 0.75rem; padding-top: 0.5rem; padding-bottom: 0.5rem; line-height: 1.5rem; font-size: 1rem;margin-left: 10px;"
            ...
            <?php foreach ($subtasks as $index => $subtask): ?>
                <div class="subtask-item flex items-center space-x-2">
                    <input type="text" name="subtasks[]"
                           ...
                           placeholder="Descripción de la subtarea" value="<?php echo htmlspecialchars($subtask); ?>" style="margin-top: 0.25rem; display: block; width: 100%; border-radius: 0.375rem; border: 1px solid #d1d5db; box-shadow: 0 1px 2px 0 rgba(0,0,0,0.05); background-color: #ffffff; padding-left: 0.75rem; padding-right: 0.75rem; padding-top: 0.5rem; padding-bottom: 0.5rem; line-height: 1.5rem; font-size: 1rem;">
                    <button type="button"
    ...
    function removeSubtask(button) {
        const container = document.getElementById('subtasks-container');
        const item = button.closest('.subtask-item'); // Use closest()
        if (item && container.contains(item)) { // Check if item is still in the container
